...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 11, 2020 at 05:49 AM
...
INSERT INTO `banks` (`id`, `Name`, `AccountNumber`) VALUES
...
(3, 1, 'Computer Science', 'A', 'Cs'),
(4, 1, 'Accountancy', 'B', 'Acc'),
(5, 2, 'Computer Science', 'B', 'Cs');
...
(0, 'kevih', 'male', '2020-12-11', 'avatar.png', '23423', 1, 1, 1, '2020-12-01', 1, 1, 110000, 12000, 0, 1);
