...
// Attempt select query execution
  $sql = "SELECT examresults.id,students.FullName,students.RegNo,classes.Name as class_name,streams.Name as stream_name,examcategories.Name as category_name,
  subjects.Name as subject_name,examresults.Marks, sessions.Year,sessions.Term 
  FROM
   examresults,classes,streams,students,examcategories,subjects,sessions 
  WHERE
   examresults.student = students.id and examresults.Subject = subjects.id and examresults.Term = sessions.id AND
    examresults.Class = classes.id and examresults.Stream = streams.id";
