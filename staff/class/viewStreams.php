...
// Attempt select query execution
  $sql = "SELECT classes.id,class_name FROM classes, streams ,teacher_classes
  where streams.class_id = classes.id AND streams.option_id != 'NULL' and streams.id = teacher_classes.stream_id
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        while($row = mysqli_fetch_array($result)){
            ...
            ";
              ...
              echo "<td>";
              $id = $row["id"];
              $sql2 = "SELECT class_name,option_name,classes.id ,abbreviation
            ...
            while($row2 = mysqli_fetch_array($res)){
              echo "" . $row2['abbreviation'] . "(" . $row2['option_name'] ."),";
            }
          }
          echo "</td>";
