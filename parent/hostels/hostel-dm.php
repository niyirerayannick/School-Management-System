...
include("../config.php");
  ...
  function addNewhostel($name,$capacity,$status){
    include("../config.php");
       ...
       $sql = "INSERT INTO `hostels` (`id`, `Name`,`capacity`,`status`) VALUES (NULL, '$name','$capacity','$status')";
  ...
  function updatehostel($name,$capacity,$status,$id){
    include("../config.php");
       ...
       $sql = "UPDATE `hostels` SET `Name` = '$name', `capacity` = '$capacity', `Status` = '$status' WHERE `hostels`.`id` = '$id';
       ";
                             ...
                             <form >
                              <div class='card-body'>
                                ...
                                <div class='form-group'>
                                    ...
                                    <input type='text' class='form-control' id='HostelName' value= " . $row['Name'] ."
                                     placeholder='Enter The Hostel Name' name='hostel_name' required>
                                </div>
                                <div class='form-group'>                            
                             </div>
                             <div class='form-group'>
                                 <label name='class-name'>Hostel Capacity</label>
                                 <input type='text' class='form-control' id='className' value= " . $row['capacity'] ."
                                  placeholder='Enter The Hostel Capacity' name='capacity' required>
                             </div>
