...
include("../config.php");
  ...
  function addNewBank($name,$account){
    include("../config.php");
       ...
       $sql = "INSERT INTO `banks` (`id`, `Name`,`AccountNumber`) VALUES (NULL, '$name','$account')";
  ...
  function updateBank($name,$account,$id){
    include("../config.php");
       ...
       $sql = "UPDATE `banks` SET `Name` = '$name', `AccountNumber` = '$account' WHERE `banks`.`id` = '$id';";
                             ...
                             <form >
                              <div class='card-body'>
                                <div class='form-group'>
                                    ...
                                    <input type='text' class='form-control' id='BankName' value= " . $row['Name'] ."
                                      name='Bank_name' required>
                                </div>
                                 <div class='form-group'>
                                    <label name='class-name'>Bank Account</label>
                                    <input type='text' class='form-control' id='BankAccount' value= " . $row['AccountNumber'] ."
